...
export const SET_HALF_AUTHENTICATION_TOKEN_FOR_PARENT =
  'SetHalfAuthenticationTokenForParent';
export const EXPLORER_LISTENING_FOR_HALF_TOKEN =
  'ExplorerListeningForHalfToken';
export const HALF_AUTHENTICATION_TOKEN_RESPONSE =
  'HalfAuthenticationTokenResponse';
